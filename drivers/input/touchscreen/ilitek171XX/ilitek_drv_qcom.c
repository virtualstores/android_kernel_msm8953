...
#define MSG_TP_IC_NAME "ilitek_i2c" //"msg22xx" or "msg28xx" /* Please define the mstar touch ic name based on the mutual-capacitive ic or self capacitive ic that you are using */
...
static int __init touch_driver_init(void)
{
    ...
    printk("VS Custom version reverse X&Y\n");
    return ret;
}
